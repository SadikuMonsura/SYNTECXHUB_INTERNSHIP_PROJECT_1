...
### Creation of Discount Band

To make discount analysis easier to interpret, a new Discount Band column was created using DAX.

The discount values were grouped into meaningful categories:
...
This transformation made it easier to compare business performance across different discount levels.

The discount band analysis was used to evaluate:
...
A dedicated Calendar table was created to support accurate time-based analysis.

The Calendar table enabled the analysis of:
- Year
- Month
- Quarter
- Date
...
The Calendar table was particularly important for calculating time-intelligence measures and ensuring that monthly comparisons were accurate.

### Data Modeling

A structured data model was developed in Power BI to support efficient analysis and visualization.

The Calendar table was used as the primary date dimension for time-based analysis.

This modeling approach enabled the dashboard to analyze sales performance across different time periods and supported calculations such as:
- Previous Month Sales
- Previous Month Profit
- Sales Growth
- Profit Growth

The use of a dedicated Calendar table also helped improve the accuracy of month-over-month analysis.

### DAX Measures and Calculations

Several DAX measures were created to support the analysis and dashboard KPIs.

The key measures included:

1. Total Revenue: Used to measure the total value generated from sales transactions.
2. Total Profit: Used to determine the overall profit generated by the business.
3. Profit Margin: Used to measure profitability relative to revenue.
4. Sales Growth: Used to measure the change in sales performance compared with the previous period.
5.  Profit Growth: Used to measure changes in profit compared with the previous period.
6. Previous Month Sales: Used as a benchmark for calculating month-over-month sales growth.
7. Previous Month Profit: Used as a benchmark for calculating month-over-month profit growth.
8. Total Cost: Used to measure the total cost associated with the products sold.
9. Total Quantity: Used to determine the total number of units sold.
10. Total Transactions: Used to measure the number of sales transactions recorded.
11. Average Discount: Used to determine the average discount applied across transactions.
12. Discount Band: Used to categorize discounts into meaningful ranges for comparative analysis.

###  Key Performance Indicators (KPIs)

The dashboard provides an overview of several important business performance indicators.

Based on the dashboard shown, the key metrics include:
- Total Quantity Sold : 25.35K 
- Total Revenue : $70.33M 
- Total Profit : $6.49M 
- Sales Growth : 0.09% 
- Profit Margin : 9.22% 
